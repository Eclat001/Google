...
public class validPreorder {
    ...
    public static void main(String... args) {
    	...
    	String s2 = "1,#";
    	String s3 = "9,#,#,1";
    	System.out.println(validPreorder.isValidSerialization(s1));
    	System.out.println(validPreorder.isValidSerialization(s2));
    	System.out.println(validPreorder.isValidSerialization(s3));
    }
}
