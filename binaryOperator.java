...
public class binaryOperator {
    ...
    static void binaryOp(String num, int target, List<String> res, String path, int pos, int sum, int pre) {
        if (pos == num.length()) {
            if (sum == target) {
                res.add(path);
                return;
    ...
    public static void main(String[] args) {
    	String s1 = "123";
    	int target1 = 6;
    	System.out.println(binaryOperator.addOperators(s1, target1));
    	String s2 = "232";
    	int target2 = 8;
    	System.out.println(binaryOperator.addOperators(s2, target2));
    	String s3 = "105";
    	int target3 = 5;
    	System.out.println(binaryOperator.addOperators(s3, target3));
    	String s4 = "00";
    	int target4 = 0;
    	System.out.println(binaryOperator.addOperators(s4, target4));
    	String s5 = "3456237490";
    	int target5 = 919;
    	System.out.println(binaryOperator.addOperators(s5, target5));
    }
}
