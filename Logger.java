...
public class Logger {
//Instead of logging print times, store when it's ok for a message to be printed again. Should be slightly faster, because don't always have to add or subtract (e.g., timestamp < log[message] + 10) but only do in the true case.
